...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_INNER_PRISM                              ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, ElevatedPrismShapes.INNER),
    ...
    FRAMED_INNER_SLOPED_PRISM                       ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, ElevatedSlopedPrismShapes.INNER),
    ...
    FRAMED_INV_DOUBLE_SLOPE_SLAB                    ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, InverseDoubleSlopeSlabShapes.INSTANCE),
    FRAMED_ELEVATED_DOUBLE_SLOPE_SLAB               ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    FRAMED_STACKED_SLOPE_SLAB                       ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, ElevatedSlopeSlabShapes.INSTANCE),
    ...
    FRAMED_FLAT_INV_DOUBLE_SLOPE_SLAB_CORNER        ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, new FlatInverseDoubleSlopeSlabCornerShapes()),
    ...
    FRAMED_FLAT_STACKED_SLOPE_SLAB_CORNER           ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FlatElevatedSlopeSlabCornerShapes.OUTER),
    FRAMED_FLAT_STACKED_INNER_SLOPE_SLAB_CORNER     ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FlatElevatedSlopeSlabCornerShapes.INNER),
    ...
    FRAMED_INV_DOUBLE_SLOPE_PANEL                   ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, InverseDoubleSlopePanelShapes.INSTANCE),
    FRAMED_EXTENDED_DOUBLE_SLOPE_PANEL              ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    FRAMED_STACKED_SLOPE_PANEL                      ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, ExtendedSlopePanelShapes.INSTANCE),
    ...
    FRAMED_FLAT_INV_DOUBLE_SLOPE_PANEL_CORNER       ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, new FlatInverseDoubleSlopePanelCornerShapes()),
    ...
    FRAMED_FLAT_STACKED_SLOPE_PANEL_CORNER          ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FlatExtendedSlopePanelCornerShapes.OUTER),
    FRAMED_FLAT_STACKED_INNER_SLOPE_PANEL_CORNER    ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, FlatExtendedSlopePanelCornerShapes.INNER),
    ...
    FRAMED_INV_DOUBLE_CORNER_SLOPE_PANEL            ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, new InverseDoubleCornerSlopePanelShapes()),
    FRAMED_INV_DOUBLE_CORNER_SLOPE_PANEL_W          ( true,  true,  true,  true, false,  true,  true, false, ConTexMode.FULL_EDGE, new InverseDoubleCornerSlopePanelWallShapes()),
    ...
    FRAMED_FANCY_RAIL_SLOPE                         ( true,  true, false,  true,  true, false,  true, false, ConTexMode.FULL_FACE, SlopeShapes.INSTANCE),
    FRAMED_FANCY_POWERED_RAIL_SLOPE                 ( true,  true, false,  true,  true, false,  true, false, ConTexMode.FULL_FACE, SlopeShapes.INSTANCE),
    FRAMED_FANCY_DETECTOR_RAIL_SLOPE                ( true,  true, false,  true,  true, false,  true, false, ConTexMode.FULL_FACE, SlopeShapes.INSTANCE),
    FRAMED_FANCY_ACTIVATOR_RAIL_SLOPE               ( true,  true, false,  true,  true, false,  true, false, ConTexMode.FULL_FACE, SlopeShapes.INSTANCE),
    ...
    FRAMED_DIVIDED_SLOPE                            ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, SlopeShapes.INSTANCE),
